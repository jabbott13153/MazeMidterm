...
public:
	...
	void init_texture_map()
	{
		...
		int TexRight = MyLoadCubeMapBitmap("skybox\\space_l.bmp", GL_TEXTURE_CUBE_MAP_POSITIVE_X);
		int TexLeft = MyLoadCubeMapBitmap("skybox\\space_r.bmp", GL_TEXTURE_CUBE_MAP_NEGATIVE_X);
		int TexTop = MyLoadCubeMapBitmap("skybox\\space_u.bmp", GL_TEXTURE_CUBE_MAP_POSITIVE_Y);
		int TexBottom = MyLoadCubeMapBitmap("skybox\\space_d.bmp", GL_TEXTURE_CUBE_MAP_NEGATIVE_Y);
		int TexFront = MyLoadCubeMapBitmap("skybox\\space_f.bmp", GL_TEXTURE_CUBE_MAP_POSITIVE_Z);
		int TexBack = MyLoadCubeMapBitmap("skybox\\space_b.bmp", GL_TEXTURE_CUBE_MAP_NEGATIVE_Z);

		//int TexRight = MyLoadCubeMapBitmap("skybox\\l_r.bmp", GL_TEXTURE_CUBE_MAP_POSITIVE_X);
		//int TexLeft = MyLoadCubeMapBitmap("skybox\\l_l.bmp", GL_TEXTURE_CUBE_MAP_NEGATIVE_X);
		//int TexTop = MyLoadCubeMapBitmap("skybox\\l_u.bmp", GL_TEXTURE_CUBE_MAP_POSITIVE_Y);
		//int TexBottom = MyLoadCubeMapBitmap("skybox\l_d.bmp", GL_TEXTURE_CUBE_MAP_NEGATIVE_Y);
		//int TexFront = MyLoadCubeMapBitmap("skybox\\l_ft.bmp", GL_TEXTURE_CUBE_MAP_POSITIVE_Z);
		//int TexBack = MyLoadCubeMapBitmap("skybox\\l_b.bmp", GL_TEXTURE_CUBE_MAP_NEGATIVE_Z);
