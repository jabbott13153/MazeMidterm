 ...
 * Ported to OpenGL 3.3 by Movania Muhammad Mobeen
 *
 *
...
/**********************************************************
*
* FUNCTION MyLoadTGA(char *)
*
* This function loads a TGA file using TGALoader and returns the OpenGL reference ID to use that texture
*
*********************************************************/

int MyLoadTGA(char *filename)
{
	

	NS_TGALOADER::IMAGE Image;

	// Actually load the TGA texture
	...
	// Use only the texture map to color polys, not texture coord colors.
